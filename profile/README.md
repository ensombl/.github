<p align="center">
  <img src="https://ensombl.io/ensombl.svg" alt="Ensombl" width="240">
</p>

<p align="center"><strong>We build trust infrastructure.</strong></p>

<p align="center">
  <a href="https://ensombl.io">ensombl.io</a>
  &middot;
  <a href="mailto:contact@ensombl.io">contact@ensombl.io</a>
  &middot;
  Singapore
</p>
...
Ensombl is a Singapore-based software studio. We build our own platform products and take on selected client work where we think we can move the needle.
...
We take on a small number of engagements per year, focused on:

- Greenfield product builds (MVP to production)
- Identity, KYC, and biometric integrations
- AWS / Cloudflare infrastructure work
- Technical due diligence and pre-launch audits

Reach out at [contact@ensombl.io](mailto:contact@ensombl.io) if you'd like to talk.
...
A few pieces we've published for the community:
...
- Web: [ensombl.io](https://ensombl.io)
- Email: [contact@ensombl.io](mailto:contact@ensombl.io)
- Based in Singapore
